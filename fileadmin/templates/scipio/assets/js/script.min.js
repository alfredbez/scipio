...
$(document).foundation(),$(document).ready(function(a){var t,n=a(".large-navi ul"),e=n.attr("data-act");n.find("li").each(function(n,i){t=a(i).find("a").attr("href"),t=t.substr(0,t.lastIndexOf(".")),e===t&&a(i).addClass("active")});var i=50;if(a("#articles").length>0){var o=new Masonry("#articles",{itemSelector:".article"});setTimeout(function(){o.layout()},i)}var r=(a(".large-navi").offset().top,function(){var t=a(window).scrollTop();0>t&&(t=0),a(".large-navi").css({top:t})});r(),a(window).scroll(function(){r()})});